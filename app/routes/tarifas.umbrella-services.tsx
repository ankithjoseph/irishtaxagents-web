      ...
      <div className="bg-white shadow-sm">
        ...
        >
          ...
          <p className="mx-auto mt-4 max-w-2xl text-xl text-neutral-500">
            Soluciones "Umbrella" para profesionales independientes obligados a
      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid gap-12 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2">
            <div className="prose prose-neutral max-w-none text-neutral-700">
              <p className="lead text-lg">
                <strong>
                  La mayoría de profesionales opta por la constitución de una
                  limited company, aunque en la práctica, esta opción no es la
                  mejor ni la más barata.{" "}
                  <p>
                    Nosotros le contratamos y le pagamos en función de su
                    facturación.
                  </p>
                </strong>
              </p>
              <br></br>
              <p>
                Nuestro servicio "Umbrella" elimina la carga administrativa.
                Usted se centra en trabajar para sus clientes, y nosotros nos
                encargamos de facturar, gestionar sus gastos y procesar su
                nómina en Irlanda con total cumplimiento legal.
              </p>
            </div>
          ...
          <div className="lg:col-span-1">
            <div
              className="sticky top-8 rounded-2xl border border-neutral-200
                bg-white p-8 shadow-lg ring-1 ring-black/5"
            >
              <h3 className="text-lg leading-8 font-semibold text-neutral-900">
                Tarifa
              </h3>
              ...
              <p className="mt-1 text-sm text-neutral-500">
                por nómina de profesional
              </p>

              <div className="mt-6 border-t border-neutral-100 pt-6">
                <p className="text-sm text-neutral-600">
                  <strong>Nota:</strong> IVA y tasas no incluidas en esta
                  tarifa.
                </p>
              </div>
              ...
              <div className="mt-8">
                <Link
                  to="/contacto"
                  className="block w-full rounded-md bg-blue-600 px-3 py-3
